...
#/usr/local/lib/python3.7/dist-packages/pybullet_data文件夹下
...
class Laikago(minitaur.Minitaur):
  ...
  def ComputeJacobian(self, leg_id):
    ...
    #golaoxu： error in this function, change it 
...
""" 
  def ComputeMotorAnglesFromFootLocalPosition(self, leg_id,
      ...
      Args:
        ...
        foot_local_postion: The foot link's position in the base frame.

      Returns:
        A tuple: The position indices and the angles for all joints alone the 
