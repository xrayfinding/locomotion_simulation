...
# VSMC 增益：
# Kx = np.array((9000., 9000., 9000., 9000., 9000., 9000.))*1
# Ka = np.array((6000., 6000., 6000., 6000., 6000., 6000.))*0.1
# Dx = np.array((240., 240., 240., 240., 240., 240.))*10
# Da = np.array((280., 280., 280., 280., 280., 280.))*10
...
class TorqueStanceLegController(leg_controller.LegController):
  ...
  def get_action(self):
    ...
    # 0.026 表示 VH
    hip1_In_base = np.array((0.22, -0.0875, 0.0))
    hip2_In_base = np.array((-0.22, 0.0875, 0.0))
